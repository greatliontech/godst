...
// exceeds exploreBudgetClamp (half MaxInt32 — the runtime's page-node pool
// doubles it and chains 1-based int32 indices): the default is
// exploreMaxAccesses (1<<16), and ExploreOptions.MaxAccesses — the arc-scale
// override — clamps there (exploreConfigFromOptions). MaxSteps raises only
// the decision budget.
